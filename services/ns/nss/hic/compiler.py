...
SAFE_CODEBOOK = [
    ...
    {"pattern": "system status",         "op": "http.health_check",     "args": {"url": "http://localhost:9000/healthz", "expect_status": 200},                  "risk": "R0"},
    {"pattern": "who am i",              "op": "ns.memory_recent",      "args": {"n": 1},                                                                 "risk": "R0"},
    {"pattern": "list capabilities",     "op": "adapter.list_capabilities", "args": {},                                                                   "risk": "R0"},
    {"pattern": "check voice",           "op": "http.health_check",     "args": {"url": "http://localhost:9000/voice/health", "expect_status": 200},             "risk": "R0"},
    ...
    {"pattern": "recent decisions",      "op": "http.health_check",     "args": {"url": "http://localhost:9000/explain/recent", "expect_status": 200},           "risk": "R0"},
    {"pattern": "flywheel status",       "op": "http.health_check",     "args": {"url": "http://localhost:9000/invention/flywheel", "expect_status": 200},       "risk": "R0"},
    ...
    # ── NS self-awareness ─────────────────────────────────────────────────────
    {"pattern": "check capability gaps", "op": "http.health_check",     "args": {"url": "http://localhost:9000/capability/unresolved", "expect_status": 200},    "risk": "R0"},
    {"pattern": "show flywheel state",   "op": "http.health_check",     "args": {"url": "http://localhost:9000/invention/flywheel", "expect_status": 200},       "risk": "R0"},
    {"pattern": "list semantic candidates", "op": "http.health_check",  "args": {"url": "http://localhost:9000/semantic/candidates", "expect_status": 200},      "risk": "R0"},
    {"pattern": "check policy proposals","op": "http.health_check",     "args": {"url": "http://localhost:9000/semantic/proposals", "expect_status": 200},       "risk": "R0"},
    {"pattern": "recent ops",            "op": "http.health_check",     "args": {"url": "http://localhost:9000/ops/recent", "expect_status": 200},               "risk": "R0"},
    ...
    {"pattern": "open founder console",      "op": "http.health_check",     "args": {"url": "http://localhost:9000/founder", "expect_status": 200},              "risk": "R0"},
    {"pattern": "check voice health",        "op": "http.health_check",     "args": {"url": "http://localhost:9000/voice/health", "expect_status": 200},         "risk": "R0"},
    {"pattern": "run sovereign boot",        "op": "http.health_check",     "args": {"url": "http://localhost:9000/healthz", "expect_status": 200},              "risk": "R0"},
    {"pattern": "show model status",         "op": "http.health_check",     "args": {"url": "http://localhost:9000/models/status", "expect_status": 200},        "risk": "R0"},
    {"pattern": "check sms",                 "op": "http.health_check",     "args": {"url": "http://localhost:9000/sms/health", "expect_status": 200},           "risk": "R0"},
    # ── Vision ops ────────────────────────────────────────────────────────────
