...
#ifndef NSINFINITYAPP_SWIFT_H
#define NSINFINITYAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NSInfinityApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13NSInfinityApp11AppDelegate")
...
@protocol MTLDevice;
@class NSCoder;
SWIFT_CLASS("_TtC13NSInfinityApp15OrganismMTKView")
@interface OrganismMTKView : MTKView
...
SWIFT_CLASS("_TtC13NSInfinityApp16OrganismRenderer")
@interface OrganismRenderer : NSObject <MTKViewDelegate>
